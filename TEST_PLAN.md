...
- `PATCH /api/v1/employees/{id}/contracts/{contractId}/end-date`
- `POST /api/v1/payroll/calculate/{employeeId}`
- `GET /api/v1/payroll/{payrollId}`
- `GET /api/v1/payroll/employee/{employeeId}`
- `PATCH /api/v1/payroll/{payrollId}/confirm`
- `GET /api/v1/payroll/{payrollId}/pdf`

**Pruebas de rendimiento (k6)**
Se utilizará k6 para validar que las operaciones críticas responden dentro del umbral definido en el PRD (menos de 3 segundos). Las pruebas se ejecutarán sobre los endpoints de cálculo de salario neto y generación de PDF.
...
| **k6** | Pruebas de rendimiento: validación del tiempo de respuesta del cálculo de nómina y generación de PDF |
...
| Día 1 | Identificación de los 6 endpoints del grupo: `POST /api/v1/employees`, `GET /api/v1/employees/{id}`, `PATCH /api/v1/employees/{id}/contracts/{contractId}`, `POST /api/v1/payroll/calculate/{employeeId}`, `GET /api/v1/payroll/{payrollId}`, `PATCH /api/v1/payroll/{payrollId}/confirm` — definición del contrato esperado (método, path, request, response) | QA |
...
| Día 2 | Diseño de casos de prueba de API para Karate: verificación de códigos HTTP, estructura de respuesta y datos persistidos para los 4 endpoints del grupo: `PATCH /api/v1/employees/{id}`, `PATCH /api/v1/employees/{id}/contracts/{contractId}`, `PATCH /api/v1/payroll/{payrollId}/confirm`, `GET /api/v1/payroll/{payrollId}/pdf` | QA |
| Día 2 | Diseño del caso de prueba de rendimiento para k6: tiempo de respuesta ≤ 3 segundos en `GET /api/v1/payroll/{payrollId}/pdf` | QA |
...
| Scripts k6 | Scripts de prueba de rendimiento para `POST /api/v1/payroll/calculate/{employeeId}` y `GET /api/v1/payroll/{payrollId}/pdf` |
