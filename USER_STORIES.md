...
```gherkin
        Given el administrador de Recursos Humanos
        And existe un empleado registrado con los datos necesarios (nombre, tipo de contrato y sueldo bruto)
...
```gherkin
        ...
        And existe un empleado registrado con los datos necesarios (nombre, tipo de contrato y sueldo bruto)
        And la nómina del empleado no fue confirmar
        When el administrador intenta cambiar el nombre del empleado por uno que contiene caracteres
